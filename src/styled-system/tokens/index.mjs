const tokens = {
  ...
  "colors.main-bgColor": {
    "value": "#000000",
    "variable": "var(--colors-main-bg-color)"
  },
  "colors.main-textColor": {
    "value": "#FFFFFF",
    "variable": "var(--colors-main-text-color)"
  },
  "colors.orange-bgColor": {
    "value": "#F7931E",
    "variable": "var(--colors-orange-bg-color)"
  },
  "colors.purpleBlue-bgColor": {
    "value": "#1F2CA0",
    "variable": "var(--colors-purple-blue-bg-color)"
  },
  "breakpoints.sm": {
    "value": "640px",
